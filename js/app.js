...
const sendMail = () =>
{
    ...
    window.open(`mailto:kontakt@mpawlak.dev?subject=${values[0]}%20-%20${values[1]}&body=${values[2].replace(' ', '%20')}`);
};
...
window.onload = () =>
{
    setTimeout(() =>
    {
        ...
        document.getElementById(mobileCheck() ? 'mobile' : 'login').style.display = 'flex';
    }, 4000);
};